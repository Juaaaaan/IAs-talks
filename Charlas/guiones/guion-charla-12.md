...
📌 **AÑADIDO — después de la demo de temperature, antes de pasar a chain-of-thought:**

> *"Y hay una cosa que estos sistemas han cambiado y que no es obvia. Antes, cuando un sistema fallaba, lo sabías. Error, pantalla roja, algo se rompía. Ahora la IA no se rompe. Te da una respuesta que suena bien, que está bien escrita, que parece correcta… pero puede estar equivocada. Y como suena bien, no la cuestionas."*
>
> *"Antes, la corrección era lo normal y los errores eran visibles. Ahora, lo normal es que suene bien — y los errores son invisibles."*
...
📌 **AÑADIDO — como cierre del Nivel 2, justo antes de pasar al Nivel 3:**

> *"Estos diez conceptos os dan las palancas. Pero la habilidad más importante con IA no es saber usarla. Es saber cuándo dudar del resultado. Todo el mundo puede escribir un prompt. No todo el mundo sabe detectar cuándo la respuesta no es de fiar."*
...
📌 **AÑADIDO — después de la frase de anclaje, como refuerzo del impacto:**

> *"Y hay algo más que habéis hecho sin daros cuenta. Habéis seguido un patrón que se repite en toda la historia de la tecnología: primero accedéis, luego exploráis, luego combináis, y de repente estáis construyendo algo más complejo de lo que parecía. Eso es exactamente lo que ha pasado en estas charlas."*
...
📌 **AÑADIDO — después de autonomous coding agents, para contrarrestar el miedo al reemplazo:**

> *"Y aquí una cosa que importa: hay una creencia muy extendida de que la IA va a reducir el trabajo. Pero históricamente, cada vez que una tecnología ha hecho algo más barato, no se ha hecho menos — se ha hecho más. Cuando el correo electrónico fue gratis, no mandamos menos mensajes. Mandamos cientos al día. Con la IA pasa lo mismo: no vais a tener menos trabajo. Vais a poder hacer cosas que antes ni os planteabais porque eran demasiado caras o lentas."*
...
📌 **AÑADIDO — aterrizaje del AI Act para audiencia no técnica:**

> *"¿Por qué importa la gobernanza? Por una razón muy simple: la IA puede decidir, pero no puede ser responsable. No firma. No asume riesgo. No responde legalmente. Alguien tiene que hacerlo. Y ese alguien sois vosotros — o vuestra empresa."*
>
> *"El AI Act no existe porque la IA sea peligrosa. Existe porque alguien tiene que responder cuando el resultado no es correcto."*
...
📌 **AÑADIDO — cuarta idea, la más importante:**

> *"Y la cuarta, que es la más importante: la IA no os quita el trabajo de ejecutar. Os da el trabajo de decidir. Ya no se trata de hacer las cosas vosotros. Se trata de saber qué le dais a la IA, cuándo le dais la razón y cuándo le decís que no. Decidir cómo decide la IA — eso es el arnés completo."*
...
📌 **ALTERNATIVA de frase final — conecta con los documentos de J.C. Jover y con toda la serie:**

> *"Al principio de estas charlas, os enseñamos a darle instrucciones a la IA. Hoy tenéis el mapa para entender qué hace con ellas. Pero si os lleváis una sola cosa, que sea esta: cualquiera puede usar la IA. La diferencia está en quién sabe cuándo no fiarse de ella."*
...
- [ ] **Decidir entre frase final original o alternativa**
...
## Origen de los añadidos

Las frases marcadas con 📌 proceden del análisis de tres documentos de J.C. Jover (mayo-junio 2026):

1. **"De la línea de comandos a los sistemas invisibles"** — la inversión corrección/plausibilidad, el nuevo analfabetismo digital
2. **"De la simplicidad a las capas"** — el patrón cíclico democratización → exploración → combinación → complejidad
3. **"De tareas a sistemas de asignación"** — el efecto Jevons, la responsabilidad como límite de la automatización, "decides cómo decidir"
