---
type: Demo
title: "Demo — Jira + SDD con Claude Desktop (Charla 7)"
description: "Paso a paso de la demo de Charla 7: conectar Claude Desktop a Jira via MCP, leer el sprint, generar task.md y crear issues desde un spec.md"
tags: [demo, jira, mcp, claude, task-md, atlassian, sdd]
related: [charla-07-skills-mcps, mcp, sdd, arnes-completo]
charla: "Charla 7"
estado: "✅ Ejecutada"
...
**Charla:** [[charla-07-skills-mcps]]
**Herramienta:** Claude Desktop + MCP Atlassian
**Jira:** `da-ju-ia-talks.atlassian.net` — Proyecto **KAN**
**Duración:** 20–25 min
...
- Demo realizada con cuenta personal de Atlassian — el entorno corporativo tiene restricciones de acceso
