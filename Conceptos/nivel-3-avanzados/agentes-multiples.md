...
tags: [agentes, copilot, claude, developer, reviewer, calidad, patron, orchestration]
related: [copilot-instructions, frontmatter, sdd, arnes-completo, orchestration-patterns, agentic-workflows]
charla: "Charla 8"
nivel: 3
estado: "✅ Publicado"
...
## Relación con orchestration patterns

Este patrón es una implementación del **Supervisor Pattern** descrito en [[orchestration-patterns]]: el agente reviewer actúa como supervisor que valida el trabajo del developer antes de proceder.
