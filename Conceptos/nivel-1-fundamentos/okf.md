...
**Google formalizó este patrón** en junio de 2026 con el **Open Knowledge Format (OKF)**: un estándar portable, interoperable, legible por humanos y por agentes, basado en ficheros markdown con frontmatter YAML.
...
- **[[wiki-llm]]** — OKF es la formalización del patrón Wiki LLM de Karpathy
